...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_EXTRAS] = LAYOUT(
        ...
        _NUMPAD, _______, _______, _______, _______, _______, _______, KC_HOME, KC_UP, KC_END,    _______, _______, _______, _______,          _______,
        _______, _______, _______, FN_CST, FN_CT,    _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, _______, _______,                   _______,
